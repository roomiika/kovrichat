...
function LoginForm() {
  ...
  return (
    <div className="w-full max-w-sm space-y-8">
      ...
      <Button variant="outline" className="w-full border-gray-300 text-gray-700 hover:bg-gray-50" onClick={handleGoogle} loading={googleLoading}>
...
export default function LoginPage() {
  return (
    <div className="min-h-screen flex items-center justify-center bg-white px-4">
      <Suspense fallback={<div className="w-full max-w-sm h-96 animate-pulse rounded-lg bg-gray-100" />}>
        <LoginForm />
      </Suspense>
    </div>
  )
